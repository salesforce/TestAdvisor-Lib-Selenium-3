...
public class TestEventDispatching {
	...
	public void testGetTitle() {
		setEventCounters();
		assertEquals(wd.getTitle(), MockCommandExecutor.STATE_OK);
	...
	public void testImplicitlyWait() {
		setEventCounters();
		wd.manage().timeouts().implicitlyWait(5000L, TimeUnit.MILLISECONDS);
	...
	public void testPageLoadTimeout() {
		setEventCounters();
		wd.manage().timeouts().pageLoadTimeout(5000L, TimeUnit.MILLISECONDS);
