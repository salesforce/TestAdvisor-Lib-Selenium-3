 ...
 * {@link org.openqa.selenium.StaleElementReferenceException} is thrown, and all
...
public interface WebElement extends SearchContext, TakesScreenshot {
	 ...
	 * will be submitted to the remote server. If this causes the current page to
	 * change, then this method will block until the new page is loaded.
	 *
	 ...
	 * particular, we don't fire any keyboard or mouse events. If you want to ensure
	 * keyboard events are fired, consider using something like
	 * {@link #sendKeys(CharSequence...)} with the backspace key. To ensure you get
	 * a change event, consider following with a call to
	 ...
	 * buttons. For more information on which elements this method supports, refer
	 * to the <a href=
	 * "https://w3c.github.io/webdriver/webdriver-spec.html#is-element-selected">specification</a>.
	 *
	 ...
	 * {@link #findElements(By)} about finding via XPath. This method is affected by
	 ...
	 * pause, cue) are not returned, in accordance with the <a href=
	 * "http://www.w3.org/TR/DOM-Level-2-Style/css.html#CSS-CSSStyleDeclaration">DOM
	 * CSS2 specification</a> - you should directly access the longhand properties
