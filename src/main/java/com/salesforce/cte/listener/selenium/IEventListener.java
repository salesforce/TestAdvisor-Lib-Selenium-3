...
/**
 * Interface which supports registering of a listener with
 * {@link com.salesforce.cte.listener.selenium.EventDispatcher} for logging
 * purposes.
 * 
 * This is an extended version of
 * org.openqa.selenium.support.events.WebDriverEventListener. See
...
public interface IEventListener {
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver#get get(String url)}. Not
	...
	/**
	 * Called before {@link org.openqa.selenium.WebDriver#getCurrentUrl
	 * getCurrentUrl()}.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver#getCurrentUrl
	 * getCurrentUrl()}. Not called, if an exception is thrown.
	 *
	 * @param event event record
	...
	/**
	 * Called before {@link org.openqa.selenium.WebDriver#getPageSource
	 * getPageSource()}.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver#getPageSource
	 * getPageSource()}. Not called, if an exception is thrown.
	 *
	 * @param event  event record
	 * @param source returned page source
	 */
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver#getTitle getTitle()}. Not
	 * called, if an exception is thrown.
	 *
	 * @param event event record
	 * @param title returned page title
	 */
	void afterGetTitle(WebDriverEvent event, String title);

	/**
	 * Called before {@link org.openqa.selenium.WebDriver#getWindowHandle
	 * getWindowHandle()}.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver#getWindowHandle
	 * getWindowHandle()}.
	 *
	 * @param event  event record
	 * @param handle Handle to current window
	 */
	void afterGetWindowHandle(WebDriverEvent event, String handle);

	/**
	 * Called before {@link org.openqa.selenium.WebDriver#getWindowHandles
	 * getWindowHandles()}.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver#getWindowHandles
	 * getWindowHandles()}.
	 * 
	 * @param event   event record
	 * @param handles Set of handles to windows currently open
	 */
	...
	/**
	 * Called before
	 * {@link org.openqa.selenium.JavascriptExecutor#executeAsyncScript(String, Object...)
	 * executingAsyncScript(String, Object...)}.
	 * 
	 * @param event  event record
	 * @param script JavaScript script to execute
	 * @param params arguments for script
	 */
	 ...
	 * 
	 * @param event  event record
	 * @param script JavaScript script executed
	 * @param params arguments for script
	...
	/**
	 * Called before {@link org.openqa.selenium.WebDriver.Options#addCookie(Cookie)
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver.Options#addCookie(Cookie)
	 * addCookie(Cookie cookie)}.
	 * 
	 * @param event  event record
	 * @param cookie cookie to add
	...
	/**
	 * Called before
	 * {@link org.openqa.selenium.WebDriver.Options#deleteCookieNamed(String)
	...
	/**
	 * Called before
	 * {@link org.openqa.selenium.WebDriver.Options#deleteCookie(Cookie)
	...
	/**
	 * Called before {@link org.openqa.selenium.WebDriver.Options#getCookies()
	 * getCookies()}.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver.Options#getCookies()
	 * getCookies()}.
	 * 
	 * @param event   event record
	 * @param cookies set of all cookies
	 */
	...
	/**
	 * Called after
	 * {@link org.openqa.selenium.WebDriver.Options#getCookieNamed(String)
	 * getCookieNamed(String name)}.
	 * 
	 * @param event  event record
	 * @param name   name of cookie to get
	...
	/**
	 * Called before
	 * {@link org.openqa.selenium.WebDriver.ImeHandler#getAvailableEngines()
	 * getAvailableEngines()}.
	 * 
	 * @param event event record
	 */
	 ...
	 * 
	 * @param event   event record
	 * @param engines list of names of available engines
	 */
	void afterGetAvailableEngines(WebDriverEvent event, List<String> engines);

	/**
	 * Called before
	 * {@link org.openqa.selenium.WebDriver.ImeHandler#getActiveEngine()
	 * getActiveEngine()}.
	 * 
	 * @param event event record
	 */
	 ...
	 * 
	 * @param event  event record
	 * @param engine names of active engine
	 */
	void afterGetActiveEngine(WebDriverEvent event, String engine);

	/**
	 * Called before {@link org.openqa.selenium.WebDriver.ImeHandler#isActivated()
	 * isActivated()}.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver.ImeHandler#isActivated()
	 * isActivated()}.
	 * 
	 * @param event    event record
	 * @param isActive state of activation of current engine
	 */
	void afterIsActivated(WebDriverEvent event, boolean isActive);

	/**
	 * Called before {@link org.openqa.selenium.WebDriver.ImeHandler#deactivate()
	 * deactivate()}.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver.ImeHandler#deactivate()
	 * deactivate()}.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called before
	 * {@link org.openqa.selenium.WebDriver.ImeHandler#activateEngine(String)
	...
	/**
	 * Called before {@link org.openqa.selenium.WebDriver.Navigation#to(String)
	 * navigate().to(String url)} or
	 * {@link org.openqa.selenium.WebDriver.Navigation#to(URL) navigate().to(URL
	 * url)}.
	 * 
	 * @param event event record
	...
	/**
	 * Called after {@link org.openqa.selenium.WebDriver.Navigation#to(String)
	 * navigate().to(String url)} or
	 * {@link org.openqa.selenium.WebDriver.Navigation#to(URL) navigate().to(URL
	 * url)}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param url   string representation of URL
	 */
	...
	/**
	 * Called before {@link org.openqa.selenium.Alert#dismiss
	...
	/**
	 * Called after {@link org.openqa.selenium.Alert#dismiss
	 * switchTo().alert().dismiss()}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called before {@link org.openqa.selenium.Alert#accept
	...
	/**
	 * Called after {@link org.openqa.selenium.Alert#accept
	 * switchTo().alert().accept()}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called before {@link org.openqa.selenium.Alert#getText
	...
	/**
	 * Called after {@link org.openqa.selenium.Alert#getText
	 * switchTo().alert().getText()}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param text  text shown in alert
	 */
	void afterGetTextByAlert(WebDriverEvent event, String text);

	/**
	 * Called before {@link org.openqa.selenium.Alert#sendKeys(String)
	 * switchTo().alert().sendKeys(String keysToSend)}.
	 * 
	 * @param event      event record
	 * @param keysToSend keys to enter
	 */
	void beforeSendKeysByAlert(WebDriverEvent event, String keysToSend);

	/**
	 * Called after {@link org.openqa.selenium.Alert#sendKeys(String)
	 * switchTo().alert().sendKeys(String keysToSend)}. Not called, if an exception
	 * is thrown.
	 * 
	 * @param event      event record
	 * @param keysToSend keys to enter
	...
	/**
	 * Called before {@link WebDriver.TargetLocator#activeElement()
	...
	/**
	 * Called after {@link WebDriver.TargetLocator#defaultContent()
	 * TargetLocator.defaultContent()}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called before {@link WebDriver.TargetLocator#frame(int)
	 * TargetLocator.frame(..)}.
	 * 
	 * @param event      event record
	 * @param frameIndex 0-based index of frame on page
	 */
	void beforeFrameByIndex(WebDriverEvent event, int frameIndex);

	/**
	 * Called after {@link WebDriver.TargetLocator#frame(int)
	 * TargetLocator.frame(..)}. Not called, if an exception is thrown.
	 * 
	 * @param event      event record
	 * @param frameIndex 0-based index of frame on page
	 */
	...
	/**
	 * Called after {@link WebDriver.TargetLocator#parentFrame()
	 * TargetLocator.parentFrame()}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called before {@link WebDriver.TargetLocator#window(java.lang.String)
	...
	/**
	 * Called after {@link WebDriver.TargetLocator#window(java.lang.String)
	 * TargetLocator.window(..)}. Not called, if an exception is thrown.
	 * 
	 * @param event      event record
	 * @param windowName name of window
	 */
	...
	/**
	 * Called before
	 * {@link WebDriver.Timeouts#implicitlyWait(long, java.util.concurrent.TimeUnit)
	 * Timeouts.implicitlyWait(..)}.
	 * 
	 * @param event event record
	 * @param time  time to wait; to be converted using the given time unit
	 * @param unit  time unit to use to convert the given time value
	 */
	 ...
	 * Called after
	 * {@link WebDriver.Timeouts#implicitlyWait(long, java.util.concurrent.TimeUnit)
	 * Timeouts.implicitlyWait(..)}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param time  time to wait; to be converted using the given time unit
	 * @param unit  time unit to use to convert the given time value
	...
	/**
	 * Called before
	 * {@link WebDriver.Timeouts#pageLoadTimeout(long, java.util.concurrent.TimeUnit)
	 ...
	 * Called after
	 * {@link WebDriver.Timeouts#pageLoadTimeout(long, java.util.concurrent.TimeUnit)
	 * Timeouts.pageLoadTimeout(..)}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param time  time to wait; to be converted using the given time unit
	 * @param unit  time unit to use to convert the given time value
	 ...
	 * Called after
	 * {@link WebDriver.Timeouts#setScriptTimeout(long, java.util.concurrent.TimeUnit)
	 * Timeouts.setScriptTimeout(..)}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param time  time to wait; to be converted using the given time unit
	 * @param unit  time unit to use to convert the given time value
	...
	/**
	 * Called after {@link WebDriver.Window#fullscreen() Window.fullscreen()}. Not
	 * called, if an exception is thrown.
	 * 
	 * @param event event record
	 */
	...
	/**
	 * Called after {@link WebDriver.Window#getPosition() getPosition()}. Not
	 * called, if an exception is thrown.
	 * 
	 * @param event          event record
	 * @param targetPosition returned location on screen
	 */
	...
	/**
	 * Called after {@link WebDriver.Window#getSize() getSize()}. Not called, if an
	 * exception is thrown.
	 * 
	 * @param event      event record
	 * @param targetSize returned window size on screen
	 */
	...
	/**
	 * Called after {@link WebDriver.Window#maximize() Window.window()}. Not called,
	 ...
	 * 
	 * @param event          event record
	 * @param targetPosition location on screen
	 */
	void beforeSetPosition(WebDriverEvent event, Point targetPosition);

	/**
	 * Called after {@link WebDriver.Window#setPosition(Point) setPosition(..)}. Not
	 * called, if an exception is thrown.
	 * 
	 * @param event          event record
	 * @param targetPosition location on screen
	 ...
	 * 
	 * @param event      event record
	 * @param targetSize window size on screen
	 */
	void beforeSetSizeByWindow(WebDriverEvent event, Dimension targetSize);

	/**
	 * Called after {@link WebDriver.Window#setSize(Dimension) setSize(..)}. Not
	 * called, if an exception is thrown.
	 * 
	 * @param event      event record
	 * @param targetSize window size on screen
	 ...
	 * @param by              locator being used
	 * @param element         use
	 *                        {@link #afterFindElementByWebDriver(WebDriverEvent, WebElement, By)
	...
	/**
	 * Called after {@link org.openqa.selenium.interactions.Keyboard#sendKeys
	 * Keyboard.sendKeys(...)}}. Not called, if an exception is thrown.
	 * 
	 * @param event      event record
	 * @param keysToSend text to insert
	 */
	...
	/**
	 * Called before {@link org.openqa.selenium.interactions.Keyboard#pressKey
	 * Keyboard.pressKey(...)}.
	 * 
	 * @param event      event record
	...
	/**
	 * Called after {@link org.openqa.selenium.interactions.Keyboard#pressKey
	 * Keyboard.pressKey(...)}}. Not called, if an exception is thrown.
	 * 
	 * @param event      event record
	 * @param keyToPress key to press
	 */
	...
	/**
	 * Called before {@link org.openqa.selenium.interactions.Keyboard#releaseKey
	 * Keyboard.releaseKey(...)}.
	 * 
	 * @param event        event record
	 * @param keyToRelease key to release
	 */
	void beforeReleaseKey(WebDriverEvent event, CharSequence... keyToRelease);

	/**
	 * Called after {@link org.openqa.selenium.interactions.Keyboard#releaseKey
	 * Keyboard.releaseKey(...)}}. Not called, if an exception is thrown.
	 * 
	 * @param event        event record
	 * @param keyToRelease key to release
	 */
	...
	/**
	 * Called before {@link org.openqa.selenium.interactions.Mouse#click
	 * Mouse.click(...)}.
	 * 
	 * @param event event record
	 * @param where coordinates where click is performed
	 */
	void beforeClickByMouse(WebDriverEvent event, Coordinates where);

	/**
	 * Called after {@link org.openqa.selenium.interactions.Mouse#click
	 * Mouse.click(...)}}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param where coordinates where click is performed
	 */
	...
	/**
	 * Called before {@link org.openqa.selenium.interactions.Mouse#doubleClick
	 * Mouse.doubleClick(...)}.
	 * 
	 * @param event event record
	 * @param where coordinates where double click is performed
	 */
	void beforeDoubleClick(WebDriverEvent event, Coordinates where);

	/**
	 * Called after {@link org.openqa.selenium.interactions.Mouse#doubleClick
	 * Mouse.doubleClick(...)}}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param where coordinates where double click is performed
	 */
	...
	/**
	 * Called before {@link org.openqa.selenium.interactions.Mouse#mouseDown
	 * Mouse.mouseDown(...)}.
	 * 
	 * @param event event record
	 * @param where coordinates where mouse down is performed
	 */
	void beforeMouseDown(WebDriverEvent event, Coordinates where);

	/**
	 * Called after {@link org.openqa.selenium.interactions.Mouse#mouseDown
	 * Mouse.mouseDown(...)}}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param where coordinates where mouse down is performed
	 */
	...
	/**
	 * Called before {@link org.openqa.selenium.interactions.Mouse#mouseUp
	 * Mouse.mouseUp(...)}.
	 * 
	 * @param event event record
	 * @param where coordinates where mouse up is performed
	 */
	void beforeMouseUp(WebDriverEvent event, Coordinates where);

	/**
	 * Called after {@link org.openqa.selenium.interactions.Mouse#mouseUp
	 * Mouse.mouseUp(...)}}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param where coordinates where mouse up is performed
	 */
	...
	/**
	 * Called before
	 * {@link org.openqa.selenium.interactions.Mouse#mouseMove(Coordinates)
	 * Mouse.mouseMove(Coordinates where)}.
	 * 
	 * @param event event record
	 * @param where coordinates where mouse is moved to
	 */
	 ...
	 * Called after
	 * {@link org.openqa.selenium.interactions.Mouse#mouseMove(Coordinates)
	 * Mouse.mouseMove(Coordinates where)}}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param where coordinates where mouse is moved to
	 */
	...
	/**
	 * Called before
	 * {@link org.openqa.selenium.interactions.Mouse#mouseMove(Coordinates,long,long)
	 * Mouse.mouseMove(Coordinates where, longxOffset, long yOffset)}.
	 * 
	 * @param event   event record
	 * @param where   coordinates where mouse is moved to
	 ...
	 * Called before
	 * {@link org.openqa.selenium.interactions.Mouse#mouseMove(Coordinates,long,long)
	 * Mouse.mouseMove(Coordinates where, longxOffset, long yOffset)}. Not called,
	 * if an exception is thrown.
	 * 
	 * @param event   event record
	 * @param where   coordinates where mouse is moved to
	...
	/**
	 * Called before {@link org.openqa.selenium.interactions.Mouse#contextClick
	 * Mouse.contextClick(...)}.
	 * 
	 * @param event event record
	 * @param where coordinates where context click is performed
	 */
	void beforeContextClick(WebDriverEvent event, Coordinates where);

	/**
	 * Called after {@link org.openqa.selenium.interactions.Mouse#contextClick
	 * Mouse.contextClick(...)}}. Not called, if an exception is thrown.
	 * 
	 * @param event event record
	 * @param where coordinates where context click is performed
	 */
	 ...
	 * 
	 * @param event     event record
	 * @param cmd       the command which ran into an issue
	...
	/**
	 * Gets the events logged so far by the implementing listener as a string or
	 * NULL, if this makes no sense.
	 * 
	 * The event listener can present the logged events in a formatted style, ready
	 * to written to disk as-is or deny provisioning this output by returning NULL.
	 * 
